...
python $base_path/git/dynet-seq2seq-attn/src/dynmt.py --dynet-autobatch 0 --dynet-gpu-ids 1 --dynet-mem 12000 --input-dim=500 --hidden-dim=1024 --epochs=100 --lstm-layers=1 \
--optimization=ADADELTA --batch-size=60 --beam-size=5 --vocab 30000 --plot --eval-after=10000  \
$base_path/git/research/string-to-tree-nmt/data/WMT16/de-en-raw/train/wmt16.train.tok.clean.true.bpe.en \
$base_path/git/research/string-to-tree-nmt/data/WMT16/de-en-raw/train/wmt16.train.tok.clean.true.bpe.en \
$base_path/git/research/string-to-tree-nmt/data/news-de-en-50/dev/newstest2015-deen.tok.penntrg.clean.true.bpe.en \
$base_path/git/research/string-to-tree-nmt/data/news-de-en-50/dev/newstest2015-deen.tok.penntrg.clean.true.bpe.en \
$base_path/git/research/string-to-tree-nmt/data/news-de-en-50/dev/newstest2015-deen.tok.penntrg.clean.true.bpe.en \
$base_path/git/research/string-to-tree-nmt/data/news-de-en-50/dev/newstest2015-deen.tok.penntrg.clean.true.bpe.en \
$base_path/git/dynet-seq2seq-attn/results/test_de_en_auto_large
