...
def _update_vocabulary_variables(output_dir,
                                 ...
                                 scope_name,
                                 mode):
  current_size = count_lines(current_vocab_path)
...
def _create_checkpoint_from_variables(variables, output_dir, latest_step=0, session_config=None):
