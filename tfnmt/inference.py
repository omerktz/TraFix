...
from .model_helper import prepare_tmp_dataset
...
def load_data(inference_input_file, split_digits, filter_tokens=[], hparams=None):
  """Load inference data."""
  tmp_inference_input_file = prepare_tmp_dataset(inference_input_file, split_digits, filter_tokens)
  with codecs.getreader("utf-8")(
      tf.gfile.GFile(tmp_inference_input_file, mode="rb")) as f:
...
def single_worker_inference(sess,
  ...
  # Read data
  infer_data = load_data(inference_input_file, split_digits=hparams.split_numbers_in, filter_tokens=[';', ','], hparams=hparams)
